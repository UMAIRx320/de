...
def grup():
	...
	ua = 'Mozilla/5.0 (Linux; Android 9; HTC U11 Build/PQ2A.190205.003; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/85.0.4183.81 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/286.0.0.48.112;]'
...
def grup1(urls):
	...
	while True:
		try:
			ua = 'Mozilla/5.0 (Linux; arm_64; Android 11; SM-A325F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 YaApp_Android/23.10.1 YaSearchBrowser/23.10.1 BroPP/1.0 SA/3 Mobile Safari/537.36'
			miskinlu = {"user-agent": ua}
			try:
				url = use[0]
			except:
...
def crackfree(idf,pwv):
	...
	sys.stdout.flush()
	ua = random.choice(['Mozilla/5.0 (Linux; Android 11; LAVA LMX06 Build/LAVA_LMX06_SW_V13_HW_V1.0_20220610; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/94.0.4606.85 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/393.0.0.35.106;]'])
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	for pw in pwv:
		try:
...
def ceker(idf,pw):
	global cp
	ua = 'Mozilla/5.0 (Linux; Android 9; ARE-AL00 Build/HONORARE-AL00; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/79.0.3945.116 Mobile Safari/537.36[FBAN/EMA;FBLC/zh_CN;FBAV/290.0.0.15.120;]'
...
def cek_opsi():
	...
	for kes in akun:
		try:
			...
			ua = 'Mozilla/5.0 (Linux; Android 11.0.0; Huawei Y9 PRIME Build/STK-LX3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.185 Mobile Safari/537.36'
			ses = requests.Session()
